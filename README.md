...
After both DOI records are created, replace `[DATA DOI]` and `[SOFTWARE DOI]` placeholders in `manuscript/open_research_statement.txt`, `manuscript/data_software_citation.txt`, `CITATION.cff`, and this README.
